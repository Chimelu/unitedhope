...
/**
 * Footer styled with USA theme - dark background with contact info and newsletter
 */
    ...
    <footer className="bg-black text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h2 className="text-5xl md:text-6xl font-bold">
              <span className="text-red-600">United</span><span className="text-white">Hope</span>
            </h2>
            <Image
              src="https://flagcdn.com/w40/us.png"
              alt="USA Flag"
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div>
            <h3 className="text-2xl font-bold mb-2 uppercase tracking-wide">
              Subscribe to UnitedHope's Newsletter
            </h3>
            <p className="text-gray-400 mb-8 text-sm uppercase">
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-900 border border-gray-700 text-white px-4 py-3 focus:outline-none focus:border-red-500 transition-colors"
                />
              </div>
              <button
                type="submit"
